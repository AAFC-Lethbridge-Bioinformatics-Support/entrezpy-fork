...
import entrezpy.log.classlogger
...
class Requester:
  ...
  def __init__(self, wait, max_retries=9, init_timeout=10, timeout_max=60, timeout_step=5):
    ...
    self.logger = entrezpy.log.classlogger.ClassLogger(Requester)
    self.logger.log("test hallo oiuroiewriooiroieuwoiruoiewur0923u50oiejja;")
    #self.logger.info(json.dumps({__name__ : {'settings' : {'wait[s]' : self.wait,
